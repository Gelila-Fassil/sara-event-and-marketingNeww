...
function CharityEvent() {
  ...
  const heroTitle = "Conferences and  ";
  ...
  const serviceContent = [
    ...
    },
    {
      children: [
        {
          text: "We understand the importance of clear communication and effective presentations in conferences and seminars. That’s why we collaborate closely with you to design an agenda that maximizes value for your audience."
        },
      ],
    },
  ];
  ...
  const serviceDetail2 = [
    {
      children: [
        {
          text: " From sourcing state-of-the-art venues to managing speaker arrangements and technical support, Sara Events ensures a smooth experience.. ",
        },
      ],
    },
    {
      children: [
        {
          text: " What sets us apart is our attention to detail, from branded materials to interactive technology that keeps attendees engaged throughout the event",
        },
      ],
    },
  ];
