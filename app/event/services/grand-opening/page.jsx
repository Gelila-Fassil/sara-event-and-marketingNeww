...
function CharityEvent() {
  ...
  const heroTitle = "Grand  ";
  const heroSecondTitle = "opening";
  ...
  const serviceContent = [
    {
      children: [
        {
          text: "Celebrate your milestone with a grand opening event that captivates and excites your audience, leaving a remarkable first impression of your brand or venue. ",
        },
      ],
    },
    {
      children: [
        {
          text: "Grand openings are all about creating a buzz and setting the tone for future success. Sara Events curates unforgettable experiences by combining innovative themes, strategic marketing, and flawless execution.",
        },
      ],
    },
  ];
  ...
  const serviceDetail2 = [
    {
      children: [
        {
          text: "From ribbon-cutting ceremonies to immersive experiences for guests, we focus on making your grand opening a memorable celebration that aligns perfectly with your vision and goals. ",
        },
      ],
    },
    {
  ...
  const galleryImages = [
    "/aboutEvent/large_3_W7_A9014_1_cb772560c0.jpg",
    "/speech4.jpg",
    "/meeting4.webp",
    "/speech.webp",
      ...
      <section className="hero-section relative w-full h-[50vh] pt-20">
        <div className="relative w-full h-full">
          ...
          <div className="flex items-center justify-center w-full h-full z-10 relative">
            <h1 className="text-6xl font-bold mb-4 text-white leading-tight w-full text-center uppercase">
