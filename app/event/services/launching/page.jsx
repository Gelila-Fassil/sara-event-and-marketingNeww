...
function CharityEvent() {
  ...
  const heroSecondTitle = "launching";
  ...
  const serviceContent = [
    {
      children: [
        {
          text: "Make a lasting impression with our creative and impactful product launch events, designed to generate buzz and spotlight your brand’s latest innovation. ",
        },
      ],
    },
    {
      children: [
        {
          text: "At Sara Events, we understand that a product launch is a pivotal moment for any brand. Our team crafts innovative and immersive launch experiences that resonate with your target audience.",
        },
      ],
    },
  ];
  ...
  const serviceDetail2 = [
    {
      children: [
        {
          text: " We leverage creative themes, cutting-edge technology, and strategic media outreach to generate excitement and awareness. Whether it’s a live demonstration or a virtual unveiling, our product launches are designed to maximize reach and leave a powerful impression. ",
        },
      ],
    },
    {
